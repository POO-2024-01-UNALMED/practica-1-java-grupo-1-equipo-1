...
public class Serializador {
	...
	public static void objetosBase() {
		...
		//Terminal
		Terminal terminal = new Terminal("Terminal del norte", 99999999, 500, 1, 20, null,  null, 0, Destino.MEDELLIN);
		
		// Transportadoras

		// Creacion de transportadoras y asignacion a transportadoras de la terminal
		  ...
		  Transportadora transportadoraLocal = new Transportadora("Transportadora Local", 250000.0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), null, terminal, null, new ArrayList<>(), new ArrayList<>(), null, 4.7);
		    ...
		    //ASIGNACIÓN DESTINOS A TRANSPORTADORA

		      ArrayList<Destino> destinos1 = new ArrayList<>();
			    destinos1.add(Destino.COOPACABANA);
			    destinos1.add(Destino.BELLO);
			    destinos1.add(Destino.CALI);
			    destinos1.add(Destino.ITAGUI);
			    destinos1.add(Destino.ENVIGADO);
			    destinos1.add(Destino.GUARNE);
			    destinos1.add(Destino.RIONEGRO);
			    destinos1.add(Destino.MARINILLA);
			    transportadoraExpress.setDestinos(destinos1);

			    ArrayList<Destino> destinos2 = new ArrayList<>();
			    destinos2.add(Destino.SABANETA);
			    destinos2.add(Destino.LAESTRELLA);
			    destinos2.add(Destino.RIONEGRO);
			    destinos2.add(Destino.GIRARDOTA);
			    destinos2.add(Destino.GUARNE);
			    destinos2.add(Destino.MARINILLA);
			    destinos2.add(Destino.BOGOTA);
			    ...
			    destinos3.add(Destino.BUENAVENTURA);
			    destinos3.add(Destino.BUCARAMANGA);
			    ...
			    destinos4.add(Destino.BELLO);
			    destinos4.add(Destino.LAPINTADA);
			    destinos4.add(Destino.SANTAMARTA);
			    transportadoraLocal.setDestinos(destinos4);

		      ArrayList<Destino> destinos5 = new ArrayList<>();
			    destinos5.add(Destino.CARTAGENA);
			    destinos5.add(Destino.BARRANQUILLA);
			    destinos5.add(Destino.SANTAMARTA);
			    destinos5.add(Destino.BELLO);
			    destinos5.add(Destino.GIRARDOTA);
			    destinos5.add(Destino.ITAGUI);
			    destinos5.add(Destino.CALI);
			    destinos5.add(Destino.BARBOSA);
			    transportadoraRapida.setDestinos(destinos5);

		      ArrayList<Destino> destinos6 = new ArrayList<>();
			    destinos6.add(Destino.GUARNE);
			    destinos6.add(Destino.LAPINTADA);
			    destinos6.add(Destino.GUATAPE);
			    ...
			    //Listas de mecanicos que se agregaran a cada transportadora
			    				...
			    				//Mecanicos que se asignaran a la transportadora1
			    				...
			    				//Mecanicos que se asignaran a la transportadora2
			    				...
			    				//Mecanicos que se asignaran a la transportadora3
			             ...
			             mecanicos3.add(mecanico127);
			    				...
			    				//Mecanicos que se asignaran a la transportadora4
			             ...
			             mecanicos4.add(mecanico130);
			    				...
			    				//Mecanicos que se asignaran a la transportadora5
			             ...
			             mecanicos5.add(mecanico133);
			    				...
			    				//Mecanicos que se asignaran a la transportadora6
			    ...
			    //Listas de vehiculos que se van a vincular a cada transportadora
			    ...
			    //Vehiculos que se agregaran a la transportadora1
			    ...
			    //Vehiculos que se agregaran a la transportadora2
			    ...
			    //Vehiculos que se agregaran a la transportadora3
			    ...
			    //Vehiculos que se agregaran a la transportadora4
			    ...
			    //Vehiculos que se agregaran a la transportadora5
			    ...
			    //Vehiculos que se agregaran a la transportadora6
			    ...
			    vehiculos6.add(vehiculo51);
			            		...
			            		//Listas de conductores que se vincularan a cada transportadora como contratados
			            		...
			            		//Conductores que tienen contrato con la transportadora6
				...
				//Transportadora1
								...
								//Vincular la lista de viajes a la terminal
